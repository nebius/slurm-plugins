...
static int render_dump_dir(
  ...
  for (size_t i = 0; template[i] != '\0'; ++i) {
    ...
    if (render_step && template[i] == '%' && template[i + 1] == 's') {
    ...
    if (render_step && template[i] == '%' && template[i + 1] == 'J') {
      if (append_string(output, output_size, &offset, job_id) != 0 ||
...
int snccliprecon_config_render_job_dump_dir(
  ...
  return render_dump_dir(config->dump_dir, job_id, "", false, output, output_size);
}
...
int snccliprecon_config_render_step_dump_dir(
  ...
  return render_dump_dir(config->dump_dir, job_id, step_id, true, output, output_size);
}
...
static int spank_option_enabled(int val, const char *optarg, int remote) {
  ...
  if (optarg == NULL || *optarg == '\0') {
    snccliprecon_log_errorf("--%s: argument required", "snccliprecon-enabled");
    return ESPANK_BAD_ARG;
  }
...
static int spank_option_profiler_plugin(int val, const char *optarg, int remote) {
  ...
  if (optarg == NULL || *optarg == '\0') {
    snccliprecon_log_errorf("--%s: argument required", "snccliprecon-profiler-plugin");
    return ESPANK_BAD_ARG;
  }
...
static int spank_option_dump_dir(int val, const char *optarg, int remote) {
  ...
  if (optarg == NULL || *optarg == '\0') {
    snccliprecon_log_errorf("--%s: argument required", "snccliprecon-dump-dir");
    return ESPANK_BAD_ARG;
  }
...
static int spank_option_prom_dump(int val, const char *optarg, int remote) {
  ...
  if (optarg == NULL || *optarg == '\0') {
    snccliprecon_log_errorf("--%s: argument required", "snccliprecon-prom-dump");
    return ESPANK_BAD_ARG;
  }
...
static int spank_option_dump_verbose(int val, const char *optarg, int remote) {
  ...
  if (optarg == NULL || *optarg == '\0') {
    snccliprecon_log_errorf("--%s: argument required", "snccliprecon-dump-verbose");
    return ESPANK_BAD_ARG;
  }
...
static int spank_option_dump_thread_interval_microseconds(int val, const char *optarg, int remote) {
  ...
  if (optarg == NULL || *optarg == '\0') {
    snccliprecon_log_errorf("--%s: argument required", "snccliprecon-dump-thread-interval-microseconds");
    return ESPANK_BAD_ARG;
  }

  return snccliprecon_config_parse_option("dump-thread-interval-microseconds", optarg);
}
